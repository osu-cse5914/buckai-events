...
| TC-PAGES-012 | S-PAGES-8 | Search executes the current query on Enter and resets pagination for the new result set | Automated | `apps/web/src/routes/_authenticated/search/-index.test.tsx` | 6 | Always |
...
| TC-PAGES-026 | S-PAGES-3 | The You landing redirects to the default Applications subpage | Automated | `apps/web/src/routes/_authenticated/you/-index.test.tsx` | 6 | Always |
| TC-PAGES-027 | S-PAGES-11 | Search restores and executes a tag-only filter through the structured events listing path | Automated | `apps/web/src/routes/_authenticated/search/-index.test.tsx`, `apps/web/src/routes/_authenticated/search/-loader.test.tsx` | 6 | Always |
| TC-PAGES-028 | S-PAGES-11 | Search query syntax converts `tag:` tokens into structured tag filters | Automated | `apps/web/src/routes/_authenticated/search/-index.test.tsx`, `apps/web/src/routes/_authenticated/search/-loader.test.tsx` | 6 | Always |
| TC-PAGES-029 | S-PAGES-11 | Search highlights recognized `tag:` syntax inline and avoids redundant refetches for equivalent normalized filters | Automated | `apps/web/src/routes/_authenticated/search/-index.test.tsx` | 6 | Always |
| TC-PAGES-030 | S-PAGES-11 | Search keeps typed characters in order while entering extended `tag:` syntax | Automated | `apps/web/src/routes/_authenticated/search/-index.test.tsx` | 6 | Always |
| TC-PAGES-031 | S-PAGES-11 | Search query syntax supports multiple inline structured filters together | Automated | `apps/web/src/routes/_authenticated/search/-index.test.tsx`, `apps/web/src/routes/_authenticated/search/-loader.test.tsx` | 6 | Always |
| TC-PAGES-032 | S-PAGES-11 | Search shows filter-syntax hints when the search box is empty | Automated | `apps/web/src/routes/_authenticated/search/-index.test.tsx` | 6 | Always |
| TC-PAGES-033 | S-PAGES-11 | Search shows plain-text suggestions while the user is typing plain keywords and replaces the whole query when a candidate is selected | Automated | `apps/web/src/routes/_authenticated/search/-index.test.tsx` | 6 | Always |
